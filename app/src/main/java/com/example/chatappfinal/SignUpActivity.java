...
import com.example.chatappfinal.databinding.ActivitySignUpBinding;
            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(binding.Email.getText().toString(),binding.Password.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            User newuser=new User(binding.Username.getText().toString(),binding.Password.getText().toString(),binding.Email.getText().toString());
                            String id=task.getResult().getUser().getUid();
                            Toast.makeText(getApplicationContext(),"Account Created Succesfully",Toast.LENGTH_SHORT).show();
                            mfirebaseDatabase.getReference().child("Users").child(id).setValue(newuser);
